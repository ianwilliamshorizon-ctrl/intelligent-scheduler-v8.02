...
const AuthenticatedApp = () => {
    ...
    const renderCurrentView = () => {
        ...
        switch (currentView) {
            ...
            case 'jobs':
                return <JobsView onEditJob={commonProps.onEditJob} onCheckIn={(id) => setters.setCheckInJob((jobs || []).find(j => j.id === id) || null)} onOpenPurchaseOrder={(po) => setters.setPoModal({isOpen: true, po})} onSmartCreateClick={() => { setters.setSmartCreateMode('job'); setters.setIsSmartCreateOpen(true); }} />;
            case 'estimates':
