                ...
                <table className="min-w-full leading-normal">
                    <thead>
                        <tr>
                            ...
                            <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Supp. Ref</th>
                        ...
                        {sortedPurchaseOrders.map(po => {
                            ...
                            return (
                                <tr key={po.id}>
                                    ...
                                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm text-gray-500">{po.supplierReference || '-'}</td>
