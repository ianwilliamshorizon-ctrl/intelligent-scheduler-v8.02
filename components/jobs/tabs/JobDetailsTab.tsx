            ...
            <Section title="Job Details" icon={Wrench}>
                <div className="space-y-3 text-sm">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div><label className="font-semibold">Key Number</label><input name="keyNumber" type="number" value={editableJob.keyNumber || ''} onChange={onChange} className="w-full p-2 border rounded mt-1" disabled={isReadOnly}/></div>
                    </div>
                </div>
            </Section>
        </div>
