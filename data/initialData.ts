import {
    BusinessEntity, Customer, Vehicle, Job, Lift, Engineer, Invoice,
  ...
  import { getRelativeDate, splitJobIntoSegments } from '../utils/dateUtils';
  ...
  export const getInitialBusinessEntities = (): BusinessEntity[] => ([
      {
          ...
          motReminderSmsTemplate: `Hi [CustomerName], a reminder from Brookspeed...`,
          serviceReminderEmailTemplate: `Dear [CustomerName],\n\nAccording to our records...`,
          serviceReminderSmsTemplate: `Hi [CustomerName], a reminder from Brookspeed...`,
          winterCheckReminderEmailTemplate: `Dear [CustomerName],\n\nWinter Check...`,
          winterCheckReminderSmsTemplate: `Hi [CustomerName], Winter Check...`,
      },
      { 
      ...
      { 
          ...
          sorTermsAndConditions: `1. The vehicle remains the property of the owner...`
      },
  ...
  export const getInitialJobs = (): Job[] => {
      const jobs: Job[] = [
          { id: 'BPP99200001', entityId: 'ent_porsche', vehicleId: 'veh_1', customerId: 'OCON0001', description: 'Major Service & MOT', estimatedHours: 12, scheduledDate: getRelativeDate(0), status: 'Unallocated', createdAt: getRelativeDate(-2), segments: [], keyNumber: 1, mileage: 54321, technicianObservations: ['Slight oil leak from sump plug.'], estimateId: 'BPP99100001', vehicleStatus: 'On Site', partsStatus: 'Fully Received', purchaseOrderIds: ['BPP94400001'], inspectionChecklist: [], damagePoints: [] },
          { id: 'BPP99200002', entityId: 'ent_porsche', vehicleId: 'veh_4', customerId: 'DUBO0001', description: 'Brake pad replacement', estimatedHours: 4, scheduledDate: getRelativeDate(0), status: 'Unallocated', createdAt: getRelativeDate(-1), segments: [], keyNumber: 2, estimateId: 'BPP99100002', vehicleStatus: 'On Site', partsStatus: 'Awaiting Order', purchaseOrderIds: ['BPP94400002'], inspectionChecklist: [], damagePoints: [] },
          { id: 'BAV99200001', entityId: 'ent_audi', vehicleId: 'veh_2', customerId: 'ROSS0001', description: 'Annual Service', estimatedHours: 8, scheduledDate: getRelativeDate(0), status: 'Unallocated', createdAt: getRelativeDate(0), segments: [], vehicleStatus: 'On Site', partsStatus: 'Ordered', inspectionChecklist: [], damagePoints: [] },
          { id: 'BPP99200003', entityId: 'ent_porsche', vehicleId: 'veh_5', customerId: 'THOR0001', description: 'Clutch Replacement', estimatedHours: 16, scheduledDate: getRelativeDate(1), status: 'Unallocated', createdAt: getRelativeDate(0), segments: [], keyNumber: 3, vehicleStatus: 'Awaiting Arrival', partsStatus: 'Not Required', inspectionChecklist: [], damagePoints: [] },
          { id: 'BTR99200001', entityId: 'ent_trimming', vehicleId: 'veh_8', customerId: 'VINT0001', description: 'Full re-trim in Connolly leather', estimatedHours: 40, scheduledDate: getRelativeDate(1), status: 'Unallocated', createdAt: getRelativeDate(-5), segments: [], vehicleStatus: 'Awaiting Arrival', partsStatus: 'Fully Received', inspectionChecklist: [], damagePoints: [] },
          { id: 'BPP99200004', entityId: 'ent_porsche', vehicleId: 'veh_6', customerId: 'RACI0001', description: 'Track day prep & alignment', estimatedHours: 8, scheduledDate: null, status: 'Unallocated', createdAt: getRelativeDate(-3), segments: [], vehicleStatus: 'Awaiting Arrival', partsStatus: 'Not Required', inspectionChecklist: [], damagePoints: [] },
      ];
      return jobs.map(job => ({ 
          ...job, 
          segments: splitJobIntoSegments(job), 
          status: calculateJobStatus(splitJobIntoSegments(job)) 
      }));
  };
  ...
  export const getInitialSaleVehicles = (): SaleVehicle[] => {
      ...
      return [
          { id: 'sale_1', entityId: 'ent_sales', vehicleId: 'veh_1', status: 'For Sale', saleType: 'Sale or Return', prepCosts: [], overheads: [], upsells: [], nonRecoverableCosts: [], keyNumber: 4, versions: [{ versionId: v1Id, createdAt: new Date().toISOString(), listPrice: 155000, sorReturnPrice: 145000 }], activeVersionId: v1Id },
          { id: 'sale_2', entityId: 'ent_sales', vehicleId: 'veh_5', status: 'For Sale', saleType: 'Stock', purchasePrice: 180000, prepCosts: [], overheads: [], upsells: [], nonRecoverableCosts: [], keyNumber: 5, versions: [{ versionId: v2Id, createdAt: new Date().toISOString(), listPrice: 210000 }], activeVersionId: v2Id }
      ];
  };
  ...
  export const getInitialStorageLocations = (): StorageLocation[] => ([{ id: 'sl_1', name: 'Main Warehouse', capacity: 30 }]);
  ...
  export const getInitialSaleOverheadPackages = (): SaleOverheadPackage[] => ([
      { id: 'sop_1', name: 'Valet & Photos', cost: 150 },
      { id: 'sop_2', name: 'Premium Detail', cost: 450 },
  ]);