...
import {
  ...
  import { initialChecklistData } from './initialChecklistData'; // Ensure this exists or is imported correctly
  
  // ... (Existing Roles, Users, BusinessEntities, TaxRates, Customers, Vehicles, Lifts, Engineers, Jobs, Invoices, Estimates, Suppliers, ServicePackages, Parts, SaleVehicles, etc. remain the same.  I'm omitting them for brevity but ensuring the new function is added at the end)
  ...
  // Default password for all users is "1234"
  ...
  export const getInitialEstimates = (): Estimate[] => ([
      { 
          ...
          customerId: 'OCON0001', 
          vehicleId: 'veh_1', 
          issueDate: getRelativeDate(-2), 
          expiryDate: getRelativeDate(28), 
          status: 'Approved', 
          lineItems: [
              {id:'li_1', description: 'Major Service Labor', quantity: 8, unitPrice: 125, isLabor: true, taxCodeId: 'tax_2'},
              {id:'li_1_p1', description: 'Oil Filter 996/997', quantity: 1, unitPrice: 35, unitCost: 22.50, isLabor: false, partId: 'part_1', partNumber: '99610722553', taxCodeId: 'tax_2'}
          ], 
          jobId: 'BPP99200001', 
      ...
      { 
          ...
          customerId: 'DUBO0001', 
          vehicleId: 'veh_4', 
          issueDate: getRelativeDate(-1), 
          expiryDate: getRelativeDate(29), 
          status: 'Sent', 
          lineItems: [
              {id:'li_2', description: 'Brake Labor', quantity: 4, unitPrice: 125, isLabor: true, taxCodeId: 'tax_2'},
              {id:'li_2_p1', description: 'Front Brake Pads', quantity: 1, unitPrice: 145, unitCost: 95, isLabor: false, partId: 'part_8', partNumber: '99735193905', taxCodeId: 'tax_2'},
              {id:'li_2_p2', description: 'Brake Pad Wear Sensor', quantity: 2, unitPrice: 25, unitCost: 15, isLabor: false, partId: 'part_6', partNumber: '99661298400', taxCodeId: 'tax_2'}
          ], 
          createdByUserId: 'user_phil_f' 
      },
  ]);
  ...
  export const getInitialServicePackages = (): ServicePackage[] => ([
      ...
      { id: 'pkg_2', entityId: 'ent_porsche', name: 'MOT Test', totalPrice: 54.85, taxCodeId: 'tax_1', costItems: [{ id: 'c3', description: 'MOT Labor', isLabor: true, quantity: 1, unitPrice: 0, unitCost: 20 }]},
      { 
          id: 'pkg_3', 
          entityId: 'ent_porsche', 
  ...
  export const getInitialInspectionTemplates = (): InspectionTemplate[] => {
      // Convert existing checklist to template structure
