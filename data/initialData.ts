...
export const initialChecklistData = [
    {
        ...
        items: [
            { id: 'itm_oil_leak', label: 'Check for oil leaks' },
            { id: 'itm_coolant_level', label: 'Check coolant level/condition' },
            { id: 'itm_drive_belts', label: 'Check auxiliary drive belts' }
        ]
    },
    {
        ...
        title: 'Undercarriage',
        items: [
            { id: 'itm_exhaust', label: 'Check exhaust system condition' },
            { id: 'itm_suspension', label: 'Check suspension components' },
            { id: 'itm_steering', label: 'Check steering rack and gaiters' }
        ]
    }
];
...
export const getInitialRoles = (): Role[] => ([
    ...
    { id: 'role_concierge', name: 'Garage Concierge', baseRole: 'Garage Concierge', defaultAllowedViews: ['dashboard', 'concierge', 'inquiries', 'invoices', 'absence'] },
]);

// --- Users ---
export const getInitialUsers = (): User[] => ([
    { id: 'user_admin', name: 'Admin User', password: '1234', role: 'Admin', holidayApproverId: 'user_admin', holidayEntitlement: 26 },
    { id: 'user_sales', name: 'Sales User', password: '1234', role: 'Sales', holidayApproverId: 'user_admin', holidayEntitlement: 26 },
    { id: 'user_concierge', name: 'Concierge User', password: '1234', role: 'Garage Concierge', holidayApproverId: 'user_admin', holidayEntitlement: 26 },
    { id: 'user_phil_f', name: 'Phil F', password: '1234', role: 'Dispatcher', holidayApproverId: 'user_admin', holidayEntitlement: 26 },
    { id: 'user_tim', name: 'Tim', password: '1234', role: 'Dispatcher', holidayApproverId: 'user_admin', holidayEntitlement: 26 },
    { id: 'user_phil', name: 'Phil', password: '1234', role: 'Dispatcher', holidayApproverId: 'user_admin', holidayEntitlement: 26 },
    { id: 'user_lewis', name: 'Lewis', password: '1234', role: 'Engineer', engineerId: 'eng_lewis', holidayApproverId: 'user_phil_f', holidayEntitlement: 26 },
    { id: 'user_emma', name: 'Emma', password: '1234', role: 'Engineer', engineerId: 'eng_emma', holidayApproverId: 'user_phil_f', holidayEntitlement: 26 },
    { id: 'user_gary', name: 'Gary', password: '1234', role: 'Engineer', engineerId: 'eng_gary', holidayApproverId: 'user_phil_f', holidayEntitlement: 26 },
    { id: 'user_olly', name: 'Olly', password: '1234', role: 'Engineer', engineerId: 'eng_olly', holidayApproverId: 'user_phil_f', holidayEntitlement: 26 },
    { id: 'user_mike_audi', name: 'Mike', password: '1234', role: 'Engineer', engineerId: 'eng_mike_audi', holidayApproverId: 'user_phil', holidayEntitlement: 26 },
    { id: 'user_dan', name: 'Dan', password: '1234', role: 'Engineer', engineerId: 'eng_dan', holidayApproverId: 'user_phil', holidayEntitlement: 26 },
    { id: 'user_sam', name: 'Sam', password: '1234', role: 'Engineer', engineerId: 'eng_sam', holidayApproverId: 'user_phil', holidayEntitlement: 26 },
    { id: 'user_vincent', name: 'Vincent', password: '1234', role: 'Engineer', engineerId: 'eng_vincent', holidayApproverId: 'user_tim', holidayEntitlement: 26 },
...
export const getInitialBusinessEntities = (): BusinessEntity[] => ([
    {
        ...
        marketingReminderEmailTemplate: `Dear [CustomerName],\n\nWe'd like to invite you to our upcoming event, [EventName], on [DueDate].\n\nIt promises to be a fantastic day for all enthusiasts. We hope to see you there!\n\nKind regards,\nThe Brookspeed Team`,
        marketingReminderSmsTemplate: `Hi [CustomerName], you're invited to our [EventName] event on [DueDate]. We look forward to seeing you at Brookspeed!`,
    },
    { 
...
export const getInitialCustomers = (): Customer[] => {
    const customers: Customer[] = [
        ...
        { id: 'WRIG0001', forename: 'Ethan', surname: 'Wright', phone: '07700900109', email: 'ethan.w@example.com', addressLine1: '9 Custom Close', city: 'Portsmouth', postcode: 'PO1 3DD', createdDate: getRelativeDate(-40), isBusinessCustomer: true, companyName: 'Wright Electricals', marketingConsent: true, serviceReminderConsent: true },
...
export const getInitialVehicles = (): Vehicle[] => ([
    { id: 'veh_1', customerId: 'OCON0001', registration: 'GT3 RS', make: 'Porsche', model: '911 GT3 RS', type: '991.2', nextMotDate: getRelativeDate(28), nextServiceDate: getRelativeDate(50) },
    { id: 'veh_2', customerId: 'ROSS0001', registration: 'RS6 V10', make: 'Audi', model: 'RS6 Avant', type: 'C6', nextMotDate: getRelativeDate(15), winterCheckDate: getRelativeDate(25) },
    { id: 'veh_3', customerId: 'CART0001', registration: 'T6 BEN', make: 'Volkswagen', model: 'Transporter', type: 'T6.1', nextMotDate: getRelativeDate(90), nextServiceDate: getRelativeDate(90) },
    { id: 'veh_4', customerId: 'DUBO0001', registration: 'GT4 CJD', make: 'Porsche', model: 'Cayman GT4', type: '981', nextMotDate: getRelativeDate(180) },
    { id: 'veh_5', customerId: 'THOR0001', registration: 'M720 S', make: 'McLaren', model: '720S', type: 'Coupe', nextServiceDate: getRelativeDate(45) },
    { id: 'veh_6', customerId: 'RACI0001', registration: 'CUP 1', make: 'Porsche', model: '911 Cup Car', type: '991', vin: 'WP0ZZZ99ZHS7XXXXX' },
    { id: 'veh_7', customerId: 'CHEN0001', registration: 'R56 HGF', make: 'Honda', model: 'Civic', type: 'Type R', nextMotDate: getRelativeDate(10) },
    { id: 'veh_8', customerId: 'VINT0001', registration: 'E TYPE', make: 'Jaguar', model: 'E-Type Series 1', type: '4.2 Roadster', vin: 'J61XXXXXX' },
    { id: 'veh_9', customerId: 'WRIG0001', registration: 'WR16 HTE', make: 'Ford', model: 'Transit Custom', type: 'L1H1', nextMotDate: getRelativeDate(120), nextServiceDate: getRelativeDate(150) },
    { id: 'veh_10', customerId: 'PETR0001', registration: 'M4 OLP', make: 'BMW', model: 'M4 Competition', type: 'G82', nextServiceDate: getRelativeDate(200) },
]);
...
export const getInitialInspectionTemplates = (): InspectionTemplate[] => {
    ...
    const shortTemplate: InspectionTemplate = {
        ...
        description: 'Quick check for essential safety items and fluids.',
        isDefault: false,
        sections: [
            {
                ...
                title: 'Lights & Levels',
                items: [
                     { id: 'itm_lights', label: 'Check all exterior lights' },
                     { id: 'itm_wipers', label: 'Check wipers and washers' },
                     { id: 'itm_oil', label: 'Check engine oil level' },
                     { id: 'itm_coolant', label: 'Check coolant level' },
                     { id: 'itm_brake_fluid', label: 'Check brake fluid level' }
                ]
            },
            {
                id: 'sec_tyres_brakes',
                title: 'Tyres & Brakes',
                items: [
                    { id: 'itm_tyre_condition', label: 'Visual check of tyre condition' },
                    { id: 'itm_tyre_pressures', label: 'Check/adjust tyre pressures' },
                    { id: 'itm_brake_visual', label: 'Visual check of brake pads/discs (wheels on)' }
                ]
            },
            {
                 id: 'sec_final',
                 title: 'Final',
                 items: [
                     { id: 'itm_road_test', label: 'Short road test' }
                 ]
            }
        ]
    };
